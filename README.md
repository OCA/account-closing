...
--- | --- | --- | ---
[account_invoice_start_end_dates](account_invoice_start_end_dates/) | 16.0.1.0.0 | [![alexis-via](https://github.com/alexis-via.png?size=30px)](https://github.com/alexis-via) | Adds start/end dates on invoice/move lines
