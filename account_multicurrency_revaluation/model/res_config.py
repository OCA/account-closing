...
class AccountConfigSettings(models.TransientModel):
    ...
    def onchange_company_id(self, company_id):
        ...
        res['value'][
            'revaluation_loss_account_id'] = company.revaluation_loss_account_id.id
        res['value']['revaluation_gain_account_id'] = \
            company.revaluation_gain_account_id.id

        res['value'][
            'revaluation_analytic_account_id'] = company.revaluation_analytic_account_id.id
        res['value'][
            'provision_bs_loss_account_id'] = company.provision_bs_loss_account_id.id
        res['value'][
            'provision_bs_gain_account_id'] = company.provision_bs_gain_account_id.id
        res['value'][
            'provision_pl_loss_account_id'] = company.provision_pl_loss_account_id.id
        res['value'][
            'provision_pl_gain_account_id'] = company.provision_pl_gain_account_id.id
        res['value'][
            'provision_pl_analytic_account_id'] = company.provision_pl_analytic_account_id.id
        res['value'][
            'default_currency_reval_journal_id'] = company.default_currency_reval_journal_id.id
        res['value'][
            'reversable_revaluations'] = company.reversable_revaluations.id
        return res
